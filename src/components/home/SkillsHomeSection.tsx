  ...
  return useQuery({
    ...
    queryFn: async (): Promise<SkillRow[]> => {
      const { data, error } = await supabase
        .from("skills" as any)
        .select("id, name, slug, tagline, description, audience, access_level, price")
          ...
          <div className="relative flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-2xl">
              ...
              <p className="mt-3 text-[15px] lg:text-base text-white/85 leading-[1.6]">
                Done-for-you instruction files that turn any AI assistant — ChatGPT, Claude, or Gemini — into a conservative deal partner: build your buy box, screen and triage leads, pick the right exit, and underwrite a safe offer. Built from real flips, rentals, and closings. Start free with the Deal Screen.
              </p>
            </div>
